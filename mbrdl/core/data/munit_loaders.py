...
from data.svhn import SVHNSubsets, SVHNDataset
...
from data.stl10 import STLDataset
...
def get_munit_loaders(args):
    ...
    if args.dataset == 'svhn':
        ...
        return get_stl10_loaders(args)
    elif args.dataset == 'cifar10':
        return get_cifar10_loaders(args)
...
def get_svhn_loaders(args):
    ...
    if args.source_of_nat_var == 'randaugment':
        train_A = SVHNDataset('train', args.source_of_nat_var, dom='orig',
                              args=args, return_labels=False)
        train_B = SVHNDataset('train', args.source_of_nat_var, dom='randaugment',
                              args=args, return_labels=False)
        test_A = SVHNDataset('test', args.source_of_nat_var, dom='orig',
                             args=args, return_labels=False)
        test_B = SVHNDataset('test', args.source_of_nat_var, dom='randaugment',
                             args=args, return_labels=False)
    elif args.source_of_nat_var == 'rotate':
        train_A = SVHNDataset('train', args.source_of_nat_var, dom='orig',
                              args=args, return_labels=False)
        train_B = SVHNDataset('train', args.source_of_nat_var, dom='rotate',
                              args=args, return_labels=False)
        test_A = SVHNDataset('test', args.source_of_nat_var, dom='orig',
                             args=args, return_labels=False)
        test_B = SVHNDataset('test', args.source_of_nat_var, dom='rotate',
                             args=args, return_labels=False)
    else:
...
def get_stl10_loaders(args):
    """Get loaders with STL10 data for training MUNIT."""

    if args.local_rank == 0:
        print(f'Loading STL10 {args.source_of_nat_var} dataset...')
    if args.source_of_nat_var == 'randaugment':
        train_A = STLDataset('train', args.source_of_nat_var, dom='orig',
                              args=args, return_labels=False)
        train_B = STLDataset('train', args.source_of_nat_var, dom='randaugment',
                              args=args, return_labels=False)
        test_A = STLDataset('test', args.source_of_nat_var, dom='orig',
                             args=args, return_labels=False)
        test_B = STLDataset('test', args.source_of_nat_var, dom='randaugment',
                             args=args, return_labels=False)
    elif args.source_of_nat_var == 'rotate':
        train_A = STLDataset('train', args.source_of_nat_var, dom='orig',
                              args=args, return_labels=False)
        train_B = STLDataset('train', args.source_of_nat_var, dom='rotate',
                              args=args, return_labels=False)
        test_A = STLDataset('test', args.source_of_nat_var, dom='orig',
                             args=args, return_labels=False)
        test_B = STLDataset('test', args.source_of_nat_var, dom='rotate',
                             args=args, return_labels=False)
    else:
        raise Exception(f'Unknown source_of_nat_var {args.source_of_nat_var}')


    return _to_loader(train_A, train_B, test_A, test_B)

def get_cifar10_loaders(args):
    """Get loaders with CIFAR10 data for training MUNIT."""

    if args.local_rank == 0:
        print(f'Loading CIFAR10 {args.source_of_nat_var} dataset...')
    if args.source_of_nat_var == 'randaugment':
        train_A = CIFAR10Dataset('train', args.source_of_nat_var, dom='orig',
                              args=args, return_labels=False)
        train_B = CIFAR10Dataset('train', args.source_of_nat_var, dom='randaugment',
                              args=args, return_labels=False)
        test_A = CIFAR10Dataset('test', args.source_of_nat_var, dom='orig',
                             args=args, return_labels=False)
        test_B = CIFAR10Dataset('test', args.source_of_nat_var, dom='randaugment',
                             args=args, return_labels=False)
    elif args.source_of_nat_var == 'rotate':
        train_A = CIFAR10Dataset('train', args.source_of_nat_var, dom='orig',
                              args=args, return_labels=False)
        train_B = CIFAR10Dataset('train', args.source_of_nat_var, dom='rotate',
                              args=args, return_labels=False)
        test_A = CIFAR10Dataset('test', args.source_of_nat_var, dom='orig',
                             args=args, return_labels=False)
        test_B = CIFAR10Dataset('test', args.source_of_nat_var, dom='rotate',
                             args=args, return_labels=False)
    else:
        raise Exception(f'Unknown source_of_nat_var {args.source_of_nat_var}')
